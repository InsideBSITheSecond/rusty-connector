...
public final class Packet implements JSONParseable {
    ...
    public static class Builder {
        private final IServiceableService<?> flame;
        private final NakedBuilder builder = new NakedBuilder();

        public Builder(IServiceableService<?> flame) {
            this.flame = flame;
        }
        ...
        public static class ReadyForSending {
            ...
            protected ReadyForSending(IServiceableService<?> flame, NakedBuilder builder) {
                this.flame = flame;
