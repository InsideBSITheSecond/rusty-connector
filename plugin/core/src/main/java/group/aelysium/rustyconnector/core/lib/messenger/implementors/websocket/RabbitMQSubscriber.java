...
public class RabbitMQSubscriber extends MessengerSubscriber {
    public RabbitMQSubscriber(AESCryptor cryptor, IMessageCacheService<? extends ICacheableMessage> cache, PluginLogger logger, Packet.Node senderUUID, Map<PacketIdentification, List<PacketListener<? extends Packet.Wrapper>>> listeners) {
